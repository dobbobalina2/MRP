...
contract AADemoTest is RiscZeroCheats, Test {
    ...
    event DebugSeal(bytes32 claimId,  bytes seal);
    ...
    function setUp() public {
        IRiscZeroVerifier verifier = IRiscZeroVerifier(0xFD43fb59d453e72AF6C421A2Ae21B47b8a9Ca60f);
    ...
    function test_Execute() public {
        ...
        emit DebugSeal(claimId, fake_seal);
        aaDemo.execute(payable(0x23D4a8d26B777c1FDcBB74afa79CAdA1caF772F8), 1 ether  , "", claimId, fake_seal);
